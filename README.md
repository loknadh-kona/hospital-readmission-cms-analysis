...
|   |-- 02_data_cleaning.sql       # dim_hospital + fact_readmissions (typed casts, derived flags, FK)
|   |-- 03_analysis_queries.sql    # 4 business-question queries (SQL validation layer)
...
|
|-- data/
|   |-- raw/         # CMS source files - download via links below (gitignored)
|   |-- processed/   # Cleaned CSVs generated by the notebooks (gitignored)
|
...
sql/03_analysis_queries.sql      -- 4 business-question queries (validation)
